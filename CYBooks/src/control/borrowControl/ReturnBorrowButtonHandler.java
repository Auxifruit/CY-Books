...
public class ReturnBorrowButtonHandler implements EventHandler<ActionEvent> {
	...
	public void handle(ActionEvent event) {
		...
		if(borrowToValidate.getEffectiveReturnDate().equals("")) {
	    	...
	    	if(result.get().equals(yesButton)) {
		    	...
		    	try {
		            ...
		            Alert validatedBorrowAlert = new Alert(AlertType.CONFIRMATION, "The borrow has been validate.", ButtonType.OK);
